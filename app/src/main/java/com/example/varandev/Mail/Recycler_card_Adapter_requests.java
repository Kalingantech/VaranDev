...
public class Recycler_card_Adapter_requests extends FirestorePagingAdapter<Recycler_item_model_requests, Recycler_card_Adapter_requests.itemviewholder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull @NotNull Recycler_card_Adapter_requests.itemviewholder holder, int position, @NonNull @NotNull Recycler_item_model_requests model) {
